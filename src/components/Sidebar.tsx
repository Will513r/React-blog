...
const Sidebar = () => (
    <div className="w-full md:w-1/5 bg-gray-900 md:bg-gray-900 px-2 text-center fixed bottom-0 md:pt-8 md:top-0 md:right-0 h-16 md:h-screen md:border-l-4 md:border-gray-600">
