    ...
    <aside className="bg-gray-200">
      <div className="flex flex-col sm:flex-row sm:justify-around">
        <div className="h-screen w-64 bg-white">
          ...
          <nav className="mt-10">
            <a
              className="flex items-center border-r-4 border-gray-700 bg-gray-200 px-8 py-2 text-gray-700"
              href="#"
            >
              <svg
                className="h-5 w-5"
            ...
            <a
              className="mt-5 flex items-center border-r-4 border-white px-8 py-2 text-gray-600 hover:border-gray-700 hover:bg-gray-200 hover:text-gray-700"
              href="#"
            >
              <svg
                className="h-5 w-5"
          ...
          <div className="absolute bottom-0 my-10">
            <a
              className="flex items-center px-8 py-2 text-gray-500 hover:text-gray-600"
              href="#"
            >
              <svg
                className="h-5 w-5"
        ...
        <div className="mt-8 h-screen w-64 bg-gray-800 sm:mt-0">
          <div className="mt-10 flex items-center justify-center">
            <img
              className="h-6"
          ...
          <nav className="mt-10">
            <a
              className="flex items-center border-r-4 border-gray-100 bg-gray-700 px-8 py-2 text-gray-100"
              href="#"
            >
              <svg
                className="h-5 w-5"
            ...
            <a
              className="mt-5 flex items-center border-r-4 border-gray-800 px-8 py-2 text-gray-400 hover:border-gray-100 hover:bg-gray-700 hover:text-gray-100"
              href="#"
            >
              <svg
                className="h-5 w-5"
